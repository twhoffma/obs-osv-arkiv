...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ReferenceLiterature'
        db.delete_table('archive_referenceliterature')


    def backwards(self, orm):
        # Adding model 'ReferenceLiterature'
        db.create_table('archive_referenceliterature', (
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('isbn', self.gf('django.db.models.fields.CharField')(max_length=13, unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('archive', ['ReferenceLiterature'])
