...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.ref_literature'
        db.add_column('archive_item', 'ref_literature',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.ref_literature'
        db.delete_column('archive_item', 'ref_literature')
