...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.ref_literatur'
        db.add_column('archive_item', 'ref_literatur',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Removing M2M table for field ref_literatur on 'Item'
        db.delete_table('archive_item_ref_literatur')


    def backwards(self, orm):
        # Deleting field 'Item.ref_literatur'
        db.delete_column('archive_item', 'ref_literatur')

        # Adding M2M table for field ref_literatur on 'Item'
        db.create_table('archive_item_ref_literatur', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm['archive.item'], null=False)),
            ('referenceliterature', models.ForeignKey(orm['archive.referenceliterature'], null=False))
        ))
        db.create_unique('archive_item_ref_literatur', ['item_id', 'referenceliterature_id'])
    ...
    models = {
        ...
        'archive.item': {
            ...
            'ref_literatur': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
