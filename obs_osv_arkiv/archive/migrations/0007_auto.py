...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field topic on 'Item'
        db.delete_table('archive_item_topic')


    def backwards(self, orm):
        # Adding M2M table for field topic on 'Item'
        db.create_table('archive_item_topic', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm['archive.item'], null=False)),
            ('topic', models.ForeignKey(orm['archive.topic'], null=False))
        ))
        db.create_unique('archive_item_topic', ['item_id', 'topic_id'])
