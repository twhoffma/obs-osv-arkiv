...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.icon_color'
        db.add_column(u'archive_media', 'icon_color',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.icon_color'
        db.delete_column(u'archive_media', 'icon_color')
    ...
    models = {
        ...
        u'archive.media': {
            ...
            'icon_color': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
